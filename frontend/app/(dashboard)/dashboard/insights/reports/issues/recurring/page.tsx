...
import { ArrowLeft, RefreshCw, Construction } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5 flex-1">
          ...
          <div>
            ...
            <p className="text-xs text-dark/50">Issues reported multiple times, most affected locations and categories</p>
          </div>
        </div>
      </div>
