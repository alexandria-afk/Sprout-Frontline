...
import { ArrowLeft, Siren, Construction } from "lucide-react";

export default function IncidentReportsReportPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5 flex-1">
          ...
          <div>
            <h1 className="text-lg font-bold text-dark">Incident Reports Report</h1>
            <p className="text-xs text-dark/50">Incident log with severity, status, and resolution timelines</p>
          </div>
        </div>
      </div>
